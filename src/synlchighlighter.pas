...
Const
  DescricaoTiposToken: Array[TLCTokenKind] of string = ('Atributo', 'Comentário', 'Tipo Dado',
                                                        'Identificador', 'Comando', 'Nulo', 'Número',
                                                        'Função Programador', 'Espaço', 'Texto', 'Símbolo',
                                                        'Desconhecido', 'Variável', 'Final da Linha',
                                                        'Função Customizada');
