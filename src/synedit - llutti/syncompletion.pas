...
$Id: syncompletion.pas 54221 2017-02-21 12:22:59Z ondrej $
...
type
  ...
  private
    ...
    function GetItemListCount : integer; // llutti
  ...
  public
    ...
    procedure AddItem(pDisplayText, pInsertText:String); // llutti
    procedure ClearItens; // llutti
  ...
  published
    ...
    property InsertList: TStrings read FInsertList write FInsertList; // llutti
    property ItemListCount:integer read GetItemListCount; // llutti
...
begin
  ...
  FInsertList := TStringList.Create; // llutti
end;
...
function TSynBaseCompletion.GetItemListCount : integer;  // llutti
begin  // llutti
  Result := Form.ItemList.Count;  // llutti
end;  // llutti
...
procedure TSynBaseCompletion.AddItem (pDisplayText, pInsertText : String );  // llutti
begin  // llutti
  Form.ItemList.Add(pDisplayText);  // llutti
  FInsertList.Add(pInsertText);  // llutti
end; // llutti

procedure TSynBaseCompletion.ClearItens; // llutti
begin // llutti
  Form.ItemList.Clear; // llutti
  FInsertList.Clear; // llutti
end; // llutti
    ...
    with TCustomSynEdit(F.CurrentEditor) do begin
      ...
      try
        ...
        if Position>=0 then begin
          ...
          begin
            Value := ''; // llutti
            if Position < InsertList.Count then // llutti
            begin // llutti
              Value := InsertList[Position];   // llutti
            end; // llutti
            if (trim(Value) = '') then   // llutti
            begin  // llutti
            ...
            begin
              ...
              TextBetweenPointsEx[NewBlockBegin, NewBlockEnd, scamEnd] := Value;  // llutti
            ...
            if (trim(Value) = '') then  // llutti
            begin   // llutti
              Value := ItemList[Position];  // llutti
            end;  // llutti
